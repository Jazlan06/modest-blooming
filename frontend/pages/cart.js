...
export default function CartPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            <span className="font-semibold font-body text-lg text-gray-900">
                                                ₹{(p.discountPrice || p.price) * item.quantity}
                                            </span>
                                            {p.discountPrice && (
            ...
            {cart.length > 0 && (
                <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t shadow-xl px-6 py-4 flex justify-between items-center">
